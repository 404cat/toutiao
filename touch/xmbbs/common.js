...
var popup = {
	...
	open : function(pop, type, url) {
		...
		if(typeof pop == 'string') {
			$('#ntcmsg').remove();
			if(type == 'alert') {
				pop = '<div class="bz_tip cl"><dt><p>'+ pop +'</p></dt><dd class="cl hm"><input class="button2" type="button" value="&#30830;&#23450;" onclick="popup.close();"></dd></div>'
			} else if(type == 'confirm') {
				pop = '<div class="bz_tip cl"><dt><p>'+ pop +'</p></dt><dd class="cl"><a href="javascript:;" onclick="popup.close();" class="bz_btn_close grey">&#21462;&#28040;</a><a href="'+ url +'" class="bz_btn_confirm"><span>&#30830;&#23450;</span></a></dd></div>'
			}
		...
		$('#mask').css({'display':'block','width':'100%','height':'100%','position':'fixed','top':'0','left':'0','background':'black','opacity':'0.8','z-index':'100'});

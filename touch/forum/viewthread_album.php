...
.postalbum_h { width: 100%; height: 50px; position: fixed; top: 0; z-index: 99; background-color: #000; }
.postalbum_h h2 { width: 56%; float: left; text-align: center; font-size: 14px; color: #FFF; line-height: 50px; font-weight: 100; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
.postalbum_h_l { width: 22%; float: left; line-height: 50px; }
.postalbum_h_l a { color: #FFF; line-height: 50px; font-size: 16px; margin-left: 15px; float: left; }
.postalbum_h_r { width: 22%; float: right; line-height: 50px; }
.postalbum_h_r a { color: #FFF; line-height: 50px; margin-right: 15px; float: right; }
.postalbum_h_l em, .postalbum_h_r em { font-size: 12px; font-weight: 100; }
...
<div class="postalbum">
	<div class="postalbum_h">
		<div class="postalbum_h_l"><a href="javascript:history.back();" class="banzhuan_font icon-fanhui1"></a></div>	
		<h2>{lang numheader}<span id="curpic"> <!--{eval echo $curaidkey + 1}--> </span>{lang unitpaper} / {lang numtotal} $count {lang unitpaper}</h2>
	    <div class="postalbum_h_r"><a href="forum.php"><em>{lang homepage}</em></a></div>
	</div>

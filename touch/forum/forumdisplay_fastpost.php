		...
		<div class="pi cl">
			<ul class="fastpost">
				...
				<li id="fastpostsubmitline" style="display:none;">
					...
					<input type="button" value="{lang reply}" class="button2 z" name="replysubmit" id="fastpostsubmit">
					<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]&reppost=$_G[forum_firstpid]&page=$page" class="z grey mtw" style="margin-left: 20px;">{lang post_advancemode}</a>
